 ...
 * @since 18/06/16.
 */
public class SimpleElasticStoreTest {
    ...
    // Temp test while progress is ongoing...
    @Test
    public void testAbleToInsertElements() throws OperationException {
        ...
        final GetAllElements<Element> getAllElements
                = new GetAllElements.Builder<>().view(new View.Builder().entity(TestGroups.ENTITY)
                                                                        .build())
                                                .build();

        final Iterable<Element> results = store.execute(getAllElements, user);
